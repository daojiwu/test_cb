...
public class TestAppendOneToCells {
    ...
    public static void main(String[] args) {
        ...
        try {
            //领料
           String sourcePath = "E:\\yinxq\\（2任务-需求\\5 oa 采购领料-修改补的采购流程的时间\\25年领料流程号清单1.xlsx";
           String targetPath = "E:\\yinxq\\（2任务-需求\\5 oa 采购领料-修改补的采购流程的时间\\25年领料流程号清单1_3.xlsx";
           //表名
           String formName="formtable_main_268";
           //流程编号前缀
           String pre="LBJLL-";
           String lcmc="零部件研发领料申请流程";//流程名称
           String personName="彭则";//人员名称
           //节点顺序数组     申请人  部门负责人  仓库接收  归档
           String[] nodeArr={"3088","3091","3093","3090"};

            //采购
            // String sourcePath = "E:\\yinxq\\（2任务-需求\\5 oa 采购领料-修改补的采购流程的时间\\25年采购流程号清单1.xls";
            // String targetPath = "E:\\yinxq\\（2任务-需求\\5 oa 采购领料-修改补的采购流程的时间\\25年采购流程号清单1_4.xls";
            // //表名
            // String formName="formtable_main_267";
            // //流程编号前缀
            // String pre="LBJ-";
            // String lcmc="零部件研发采购申请流程";//流程名称
            // String personName="彭则";//人员名称
            // //节点顺序数组                  申请人 部门负责人 中心负责人 采购接收  归档
            // String[] nodeArr={"3080","3083","3086","3087","3082"};

            //必需对应好必要变量：process_code（原流程编号）  create_time（提单日期）  request_id（请求id）  new_process_code（新流程编号）
            ...
            System.out.println("流程名称: " + lcmc);
            System.out.println("人员名称: " + personName);
            System.out.println("节点顺序数组: " + nodeArr);
            
            ExcelUtils.appendOneToAllCells(isUpd,columnInfos,sourcePath, targetPath, formName, pre, lcmc, personName, nodeArr);
